...
campaignSchema.statics.getBoxesWithin = function getBoxesWithin(params) {
    ...
    var savedCampaign = this.create(params);
    console.log( 'LINE 70' + savedCampaign);
    var poly = savedCampaign.polygonDraw;
    console.log('LINE 72' + poly);
    var parsedPolygon = JSON.parse(poly);
    console.log('LINE 74' + parsedPolygon);
    // this.create(params).then(function (savedCampaign){
