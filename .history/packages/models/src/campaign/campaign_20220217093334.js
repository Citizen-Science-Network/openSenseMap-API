...
campaignSchema.statics.getBoxesWithin = function getBoxesWithin(params) {
        ...
        async function getPolygon() {
            ...
            console.log('CAMPAIGN ' + typeof(campaign) + campaign);
            let polygon = await JSON.parse(campaign.polygonDraw);
            console.log('POLYGON ' + typeof(polygon) + polygon);
            return polygon;
        }
        
        var poly = getPolygon();
        console.log(poly + ' POLY' + typeof(poly));
